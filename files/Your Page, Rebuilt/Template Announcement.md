...
*Part of "Accessibility for the Modern Learner." An announcement is a page: the same prompt frame, the same four-point Accessibility Checklist, the same verification habit apply.*

**PRIVACY RULE — READ FIRST:** Never paste student names, student work, or grades into a public AI model. Course content only.
...
style="..." attributes on individual elements survive. So:
 ...
 9. Headings are real heading tags in logical order, starting at <h2>
    (Canvas renders the page or announcement title as the h1).
...
> **Version note:** this file supersedes the template printed in the PDF handout. One correction: the announcement title is now an `<h2>` (the printed version used an `<h1>`, which fails Checklist criterion 1 because Canvas already renders the title as the page's h1).
...
<div style="max-width:660px;margin:0 auto;background:#f5f4f0;
  ...
  <div style="background:#12294B;padding:1.8rem 2.2rem 1.5rem;
    ...
    <p style="font-size:11px;letter-spacing:0.13em;text-transform:uppercase;
      ...
      Week [WEEK NUMBER]</p>
    <h2 style="font-family:Georgia,serif;font-size:26px;font-weight:600;
      color:#ffffff;margin:0;line-height:1.3;">[ANNOUNCEMENT TITLE]</h2>
  </div>
